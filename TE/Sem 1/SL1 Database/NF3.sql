...
CREATE TABLE `order_detail` (
  ...
  KEY `C_ID` (`C_ID`),
  CONSTRAINT `order_detail_ibfk_1` FOREIGN KEY (`C_ID`) REFERENCES `customer` (`C_ID`)
...
INSERT INTO `order_detail` VALUES (1,1,'2017-10-28',91000);
...
CREATE TABLE `order_record` (
  ...
  KEY `P_ID` (`P_ID`),
  CONSTRAINT `order_record_ibfk_1` FOREIGN KEY (`O_ID`) REFERENCES `order_detail` (`O_ID`),
...
INSERT INTO `product` VALUES (1,'Asus-Laptop',91000,4),(2,'Dell',37000,4),(3,'Sony',47000,2),(4,'Acer',33000,10),(5,'Apple',137000,2),(6,'AyanTech',2000000,2);
...
-- Dump completed on 2019-07-24 13:02:04
